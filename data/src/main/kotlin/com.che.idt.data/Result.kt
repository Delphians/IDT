package com.che.idt.data

import kotlin.contracts.ExperimentalContracts
import kotlin.contracts.InvocationKind
import kotlin.contracts.contract

internal sealed interface Result<out V, out E> {
    operator fun component1(): V?
    operator fun component2(): E?
}

internal class Success<out V>(val value: V) : Result<V, Nothing> {
...
internal class Failure<out E>(val error: E) : Result<Nothing, E> {
...
internal inline fun <V, E, U> Result<V, E>.mapBoth(success: (V) -> U, failure: (E) -> U): U {
    contract {
